    ...
    <nav className="fixed z-[100] top-2 rounded-[10px] px-2 mb-16 h-[4rem] w-[95%] bg-white/50 backdrop-blur-[100px] flex flex-col ml-[2.5%]">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          {!isLoggedIn? (
          <button onClick = {(e)=>navigate("auth")} className="bg-white text-purple-600 px-4 py-2 rounded-lg hover:bg-purple-50 transition-colors">
            Get Started
          </button>):(<div>U</div>)
          // (<CircleUserRound className='text-white size-8'/>)
          }
        </div> 
